...
import (
	...
	"github.com/swaggo/swag/examples/customfields/address"
	"github.com/swaggo/swag/examples/customfields/base"
...
type DBColumns struct {
	...
	GlobalConfigKey     *fields.StringConstantField[constants.GlobalConfigKey] `public:"view" column:"config_key"             type:"text"     default:""                   index:"true"`
	...
	Flags               *fields.StructField[*Flags]                            `public:"view" column:"flags"                  type:"jsonb"    default:"{}"                 index:"true"`
}
